...
from utils import DomainAdaptationDataset#, CustomDataset,
...
#     domB_train = CustomDataset(os.path.join(args.root, 'trainB.txt'), transform=comp_transform)
    ...
    domA_train= DomainAdaptationDataset(path_1='./custom_dataset/trainA', transforms=comp_transform)
    domB_train= DomainAdaptationDataset(path_1='./custom_dataset/trainB', transforms=comp_transform)
    ...
    if torch.cuda.is_available():
        ...
        B_separate = B_separate.to(device)
    ...
    while True:
        ...
        for domA_img, domB_img in zip(domA_loader, domB_loader):
            ...
            if _iter % args.display_iter == 0:
                ...
                save_imgs(args, e1, e2, decoder, _iter, device)
